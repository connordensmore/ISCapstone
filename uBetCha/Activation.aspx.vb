...
Partial Class Activation
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
           ...
           ConfigurationManager.ConnectionStrings("UBetChaDB").ConnectionString
            ...
            Dim cmd As New SqlCommand("DELETE FROM UserActivation WHERE ActivationCode = @ActivationCode")
